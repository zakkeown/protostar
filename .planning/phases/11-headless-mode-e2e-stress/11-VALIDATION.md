...
- [ ] `.planning/REQUIREMENTS.md` includes `STRESS-01` through `STRESS-14`.
- [ ] `.planning/ROADMAP.md` Phase 11 plan list references all generated `11-*-PLAN.md` files.
- [ ] `.planning/phases/11-headless-mode-e2e-stress/11-RESEARCH.md` exists and includes `## Validation Architecture`.
