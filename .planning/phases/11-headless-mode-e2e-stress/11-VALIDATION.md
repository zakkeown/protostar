...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 11-01-01 | 11-01-requirements-traceability-PLAN.md | 0 | STRESS-01 | - | Requirements traceability is explicit before code tasks | doc/contract | `grep -q "STRESS-14" .planning/REQUIREMENTS.md` | Pending | pending |
